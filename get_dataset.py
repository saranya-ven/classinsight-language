...
def get_utterances_embeddings(utterances_list,embed_model):
    ...
    utts_embeddings=get_sentence_embeddings(only_utt_strings,embed_model)
...
if __name__ == "__main__":
    ...
    #,encoding="utf-8"
    with open(outputfile_path,"w+") as output_csv_file:
        ...
        for period in all_periods:
            ...
            print("Embeddings calculated using model",embedding_model)
